...
-- Query to fetch all products which are constituting the first 30% (based on price)
...
-- Query to identify how much percentage more expensive is "Galaxy Z Fold 3" when compared to all PREVIOUS products.
